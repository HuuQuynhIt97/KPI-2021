...
namespace Service.Implementation
{
    ...
    public class LevelService : ILevelService
    {
        ...
        public int GetNodelevel(string code)
        {
            try
            {
                var level_id = _dbContext.KPILevels.FirstOrDefault(x => x.KPILevelCode == code).LevelID;
                var level_number = _dbContext.Levels.FirstOrDefault(x => x.ID == level_id).LevelNumber;
                return level_number.ToInt();
            }
            catch (Exception)
            {
        ...
        public int GetNodelevel_ID(string code)
        {
            try
            {
                var level_id = _dbContext.KPILevels.FirstOrDefault(x => x.KPILevelCode == code).LevelID;
                return level_id.ToInt();
            }
            catch (Exception)
            {
